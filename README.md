...
- [Flatcar Minecraft Server](#flatcar-minecraft-server)
  ...
  - [Example: Deploying on Azure Cloud ☁️](#example-deploying-on-azure-cloud-️)
    ...
    - [That’s It!](#thats-it)
  - [Community \& Project Documentation](#community--project-documentation)
...
- **Butane** *(optional but recommended)*
  If you plan to **locally** generate your Ignition file from the Butane YAML, you’ll need the [Butane CLI](https://coreos.github.io/butane/) or Docker image ([how to install docker](https://docs.docker.com/engine/install/)).
